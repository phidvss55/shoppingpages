...
@section('content')
    ...
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('admin.get.list.product') }}"> Quản lý kho </a></li>
            <li> Danh sách </li>
        </ol>
    </div>
    <div class="row">
    ...
    <h2> Quản lý sản phẩm <a href="?type=inventory" class="{{ Request::get('type') == 'inventory' ? 'active' : '' }}"> Hàng tồn </a> - <a href="?type=pay" class="{{ Request::get('type') == 'pay' ? 'active' : '' }}"> Bán chạy </a></h2>
